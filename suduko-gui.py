...
class SudokuBoard(ttk.Frame):
    ...
    def create_board(self, master, bootstyle='dark', padx=0, pady=0):
        ...
        self.hstack_boxes(row_container=row2, matrix_row_contents=[
           puzzle.boxes[4], puzzle.boxes[4], puzzle.boxes[6]])
...
class App(ttk.Frame):
    def __init__(self, master, **kwargs):
        ...
        right_container = ttk.Frame(master=self, bootstyle='dark')
    ...
    def settings_controls(self, container, padx=5, pady=5):
        hint_toolbtn = ttk.Checkbutton(master=container, text='Hint', bootstyle='default-toolbutton')
